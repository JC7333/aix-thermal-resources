  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        thermal: {
          blue: "hsl(var(--thermal-blue))",
          "blue-light": "hsl(var(--thermal-blue-light))",
        },
        healing: {
        ...
        // Catégories
        rhuma: "hsl(var(--rhuma-color))",
        veino: "hsl(var(--veino-color))",
        orl: "hsl(var(--orl-color))",
        buccal: "hsl(var(--buccal-color))",
      },
      fontFamily: {
      ...
      fontSize: {
        // Tailles accessibles
        "base-lg": ["1.125rem", { lineHeight: "1.75" }],
        "lg-xl": ["1.25rem", { lineHeight: "1.7" }],
      },
      borderRadius: {
        lg: "var(--radius)",
