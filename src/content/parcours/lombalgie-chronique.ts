...
export const lombalgieParcours: ParcoursContent = {
  ...
  proIntro:
    "Quel degré de difficulté avez-vous pour les activités suivantes, à cause de votre dos ?",
  days: [
    // ========== SEMAINE 1 : COMPRENDRE (J1-J7) ==========
    {
      ...
      content: {
        ...
        keyMessage:
          "Votre dos est solide. La douleur chronique est un signal déréglé, pas un signe de fragilité.",
        source: "WHO 2023, NICE NG59",
      },
      action: {
        title: "Marche douce — 5 minutes",
        description:
          "Marchez 5 minutes à votre rythme. Concentrez-vous sur votre posture naturelle, sans vous raidir. Laissez les bras se balancer. Le dos bouge naturellement pendant la marche — c'est exactement ce qu'il lui faut.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Le repos prolongé aggrave votre dos. Le mouvement le renforce.",
        source: "WHO 2023, HAS Lombalgie",
      },
      action: {
        title: "Chat-vache — 10 cycles",
        description:
          "À quatre pattes (genoux et mains au sol). Alternez dos rond (rentrez le ventre, baissez la tête) et dos creux (relevez la tête, cambrez doucement). Mouvements lents et fluides, respirez normalement. 10 cycles.",
        duration: "3 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Votre dos a guéri. C'est votre système d'alarme qui est encore en alerte.",
        source: "WHO 2023, Pain Neuroscience Education",
      },
      action: {
        title: "Respiration abdominale — 3 minutes",
        description:
          "Allongé sur le dos, genoux pliés. Posez une main sur le ventre. Inspirez par le nez en gonflant le ventre (4 secondes), expirez par la bouche en le rentrant (6 secondes). La main monte et descend. Cela relâche les muscles du dos profonds.",
        duration: "3 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Un IRM « anormal » est normal après 50 ans. L'imagerie n'est pas utile sans signe de gravité.",
        source: "WHO 2023, NICE NG59, HAS Lombalgie",
      },
      action: {
        title: "Marche — 8 minutes",
        description:
          "Marche de 8 minutes, terrain plat. Essayez de balancer naturellement les bras et de détendre les épaules. Le dos bouge à chaque pas — c'est son travail, et il le fait bien.",
        duration: "8 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "L'exercice est le traitement n°1. Le repos prolongé et les médicaments seuls ne sont pas la solution.",
        source: "WHO 2023, NICE NG59, Cochrane Reviews",
      },
      action: {
        title: "Gainage latéral — 3 × 10 secondes par côté",
        description:
          "Sur le côté, appuyé sur l'avant-bras et les genoux (pas les pieds pour le niveau facile). Soulevez les hanches pour faire une ligne droite. Maintenez 10 secondes, reposez. 3 fois chaque côté. Cet exercice renforce les muscles qui stabilisent votre colonne.",
        duration: "3 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "La cure relâche vos muscles et vous remet en mouvement. Le bénéfice dure si vous continuez.",
        source: "Études thermales lombalgie, Consensus",
      },
      action: {
        title: "Exercice en piscine thermale",
        description:
          "Pendant votre séance en piscine, essayez de marcher dans l'eau pendant 5 minutes. La résistance de l'eau renforce vos muscles sans charger la colonne. Si pas de piscine aujourd'hui, faites 5 min d'exercice chat-vache.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Semaine 1 terminée. Votre dos est plus solide que vous ne le pensez.",
        source: "Synthèse WHO/NICE/HAS",
      },
      action: {
        title: "Marche bilan — 10 minutes",
        description:
          "Marche de 10 minutes. Comparez vos sensations avec le jour 1. Êtes-vous plus détendu(e) ? Plus confiant(e) ?",
        duration: "10 min",
      },
      hasMiniPro: true,
      quiz: [
        {
          ...
          options: [
            "Oui, il faut se reposer",
            "Non, il aggrave la situation",
            "Seulement 1 semaine",
          ],
          correctIndex: 1,
          explanation:
            "Le repos prolongé affaiblit les muscles et amplifie la douleur. Le mouvement est le traitement.",
        },
        {
          question:
            "Un IRM « anormal » signifie-t-il que votre dos est cassé ?",
          options: [
            "Oui, c'est inquiétant",
            "Non, c'est normal avec l'âge",
            "Il faut opérer",
          ],
          correctIndex: 1,
          explanation:
            "90% des personnes sans douleur ont des « anomalies » à l'IRM. Ce sont des rides du dos.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "L'OMS et la HAS recommandent l'exercice comme traitement principal.",
        },
      ],
    },
    ...
    // ========== SEMAINE 2 : AGIR (J8-J14) ==========
    {
      ...
      content: {
        ...
        keyMessage:
          "5 exercices, 10 minutes, 3x/semaine. C'est tout ce qu'il faut.",
        source: "NICE NG59, Cochrane 2021",
      },
      action: {
        title: "Circuit découverte — 10 min",
        description:
          "Chaque exercice 5 fois (niveau facile) : chat-vache (10 cycles), planche genoux (10s × 3), gainage latéral (10s × 3 chaque côté), ponts fessiers (8 reps), étirement psoas (30s chaque côté).",
        duration: "10 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Le gainage remplace la ceinture lombaire — en plus efficace et sans effets secondaires.",
        source: "NICE NG59, Core stability evidence",
      },
      action: {
        title: "Planche — 3 × 15 secondes",
        description:
          "Avant-bras et genoux au sol. Corps droit. Maintenez 15 secondes, repos 30 secondes, 3 séries. Si trop facile, passez sur la pointe des pieds.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "3 étirements après chaque séance. La souplesse protège votre dos.",
        source: "NICE NG59, Physiotherapy consensus",
      },
      action: {
        title: "Routine étirements — 5 min",
        description:
          "Les 3 étirements : psoas (30s × 2 côtés), ischio-jambiers (30s × 2), piriforme (30s × 2). Respirez pendant chaque étirement.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "30 min de marche par jour réduit le risque de récidive de 25 à 40%.",
        source: "WHO 2023, Cochrane walking for LBP",
      },
      action: {
        title: "Marche continue — 15 min",
        description:
          "Parcours plat, 15 min sans pause. Concentrez-vous sur la détente des épaules et le balancement des bras. Si trop : 2 × 7 min avec pause 2 min.",
        duration: "15 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Une poussée est un orage — ça passe. Réduisez, bougez doucement, reprenez.",
        source: "WHO 2023, Self-management consensus",
      },
      action: {
        title: "Écrire votre plan poussée",
        description:
          "Notez les 6 étapes sur papier ou téléphone. C'est votre trousse de secours pour les mauvais jours. Gardez-la accessible.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Stress + mauvais sommeil = douleur amplifiée. Traitez les trois ensemble.",
        source: "WHO 2023, NICE NG59",
      },
      action: {
        title: "Cohérence cardiaque — 5 min",
        description:
          "Assis ou allongé, yeux fermés. Inspirez nez 5 secondes, expirez bouche 5 secondes. 5 minutes (30 cycles). App gratuite « RespiRelax » si besoin.",
        duration: "5 min",
      },
    },
    {
      ...
      action: {
        ...
        description:
          "Circuit 5 exercices (8 reps/15s chacun) + 3 étirements (30s). Chronométrez : c'est le temps de votre routine post-cure.",
        duration: "12 min",
      },
      hasMiniPro: true,
      quiz: [
        {
          ...
          options: [
            "S'allonger et ne plus bouger",
            "Réduire l'intensité mais continuer à bouger",
            "Mettre une ceinture lombaire",
          ],
          correctIndex: 1,
          explanation:
            "Réduisez l'intensité, chaleur locale, mais continuez des mouvements doux. L'immobilité aggrave.",
        },
        {
          question: "Le stress influence-t-il la douleur du dos ?",
          options: [
            "Non, c'est mécanique",
            "Oui, il amplifie la douleur",
            "Seulement chez les anxieux",
          ],
          correctIndex: 1,
          explanation:
            "Le stress augmente la sensibilisation centrale — votre système nerveux amplifie les signaux de douleur.",
        },
        {
          question:
            "Quelle activité réduit le risque de rechute de lombalgie de 25 à 40% ?",
          options: [
            "Le port de la ceinture lombaire",
            "L'arrêt du sport",
            "La marche quotidienne 30 min/jour",
          ],
          correctIndex: 2,
          explanation:
            "La marche quotidienne 30 min/jour réduit le risque de rechute de 25 à 40% selon l'OMS 2023.",
        },
      ],
    },
    ...
    // ========== SEMAINE 3 : CONSOLIDER (J15-J21) ==========
    {
      ...
      content: {
        ...
        keyMessage:
          "La régularité est la clé. Planifiez vos créneaux d'exercice maintenant.",
        source: "WHO 2023",
      },
      action: {
        title: "Écrire 3 objectifs personnels",
        description:
          "Sur papier, 3 objectifs réalistes pour 3 mois. Ex : « Marcher 20 min/jour », « Exercices 3x/semaine », « Reprendre le vélo ». Affichez-les chez vous.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "La meilleure posture est la prochaine. Variez les positions et bougez souvent.",
        source: "NICE NG59, Ergonomic consensus",
      },
      action: {
        title: "1 changement concret",
        description:
          "Identifiez 1 adaptation pour votre quotidien (alarme 30 min pour se lever, coussin entre les genoux, régler la hauteur du siège). Mettez-la en place dès ce soir.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Le meilleur exercice est celui que vous ferez. Choisissez ce qui vous plaît.",
        source: "WHO 2023",
      },
      action: {
        title: "Tester une activité",
        description:
          "Essayez une activité inhabituelle : aquagym aux thermes, yoga, Pilates, vélo. Notez votre ressenti. Pourriez-vous continuer chez vous ?",
        duration: "15-30 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Pas de régime miracle. Méditerranéen + poids raisonnable + arrêt du tabac si applicable.",
        source: "WHO 2023",
      },
      action: {
        title: "1 changement alimentaire",
        description:
          "Identifiez un petit changement : poisson 2×/semaine, plus de légumes, réduire les ultra-transformés, boire plus d'eau. Un seul changement, mais durable.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "La peur du mouvement fait plus de dégâts que le mouvement lui-même.",
        source: "WHO 2023, Fear-avoidance model",
      },
      action: {
        title: "Identifier 1 mouvement évité",
        description:
          "Quel mouvement évitez-vous par peur ? Se baisser, porter, se retourner ? Faites-le aujourd'hui, très doucement, en version allégée. Notez que rien de grave ne s'est passé.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "Préparez votre trousse anti-crise. Urgence = perte de contrôle vessie/selles ou perte de force jambes.",
        source: "WHO 2023, NICE NG59",
      },
      action: {
        title: "Préparer sa trousse",
        description:
          "Rassemblez : plan poussée (J12), 3 objectifs (J15), numéro médecin. Au même endroit.",
        duration: "5 min",
      },
    },
    {
      ...
      content: {
        ...
        keyMessage:
          "21 jours accomplis. Continuez 3×/semaine. Votre dos est plus fort que vous ne le croyez.",
        source: "WHO 2023, NICE NG59",
      },
      action: {
        title: "Remplir le bilan final",
        description:
          "Cliquez ci-dessous pour remplir votre questionnaire de fin de cure et voir vos progrès.",
        duration: "3 min",
      },
    },
  ],
