...
> = {
  gonarthrose: {
    ...
    description:
      "Comprenez votre arthrose, apprenez à bouger sans douleur, et repartez avec un plan concret pour la suite.",
    icon: "🦴",
  },
  "lombalgie-chronique": {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Comprenez votre dos, reprenez confiance dans le mouvement, et construisez votre routine anti-douleur.",
    icon: "🔙",
  },
  coxarthrose: {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Protégez votre hanche par le mouvement, améliorez votre mobilité, et préparez votre autonomie.",
    icon: "🦴",
  },
  "insuffisance-veineuse": {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Soulagez vos jambes lourdes, améliorez votre circulation, et adoptez les bons réflexes au quotidien.",
    icon: "🦵",
  },
  bpco: {
    title: "BPCO",
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Apprenez à mieux respirer, gérer l'essoufflement, et restez actif malgré la maladie.",
    icon: "🫁",
  },
  "otites-repetition-enfant": {
    ...
    description:
      "Comprenez les otites de votre enfant, apprenez les soins nasaux, et prévenez les récidives.",
    icon: "👶",
  },
  fibromyalgie: {
    title: "Fibromyalgie",
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Apprivoisez la douleur, retrouvez un sommeil réparateur, et reprenez doucement l'activité.",
    icon: "🧠",
  },
  "rhinosinusite-chronique": {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Maîtrisez l'hygiène nasale, réduisez l'inflammation, et respirez mieux au quotidien.",
    icon: "👃",
  },
  "tendinopathie-coiffe": {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Rééduquez votre épaule en douceur, renforcez vos muscles stabilisateurs, et retrouvez vos gestes.",
    icon: "💪",
  },
  "arthrose-digitale": {
    ...
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Assouplissez vos doigts, soulagez la douleur, et adaptez vos gestes quotidiens.",
    icon: "✋",
  },
  asthme: {
    title: "Asthme",
    subtitle: "Votre programme personnalisé en 3 semaines",
    description:
      "Maîtrisez votre traitement, comprenez vos déclenchants, et reprenez le sport en confiance.",
    icon: "🫁",
  },
};
  ...
  const handleTokenLookup = async () => {
    ...
    if (code.length < 8) {
      toast({
        ...
        description: "Le code ressemble à ETUVE-G-A4K7MZ",
        variant: "destructive",
      });
      return;
    }
      ...
      <Layout>
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          <p className="text-xl text-muted-foreground">
            Ce parcours n'est pas encore disponible.
          </p>
          <Link
            to="/parcours"
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-green-50 border border-green-200 text-center">
              <p className="text-green-800 font-medium text-lg">
                Vous avez déjà un parcours en cours
              </p>
            ...
            <Button
              size="lg"
              className="w-full text-xl py-7 gap-3"
              onClick={() => navigate(`/parcours/${slug}/jour/1`)}
            >
            ...
            <Button
              ...
              onClick={() => navigate(`/parcours/${slug}/bep`)}
            >
              ...
              <div className="p-4 rounded-xl border-2 border-muted space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={tokenLoading || tokenInput.length < 8}
                  >
