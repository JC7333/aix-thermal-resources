      ...
      <div className="container mx-auto px-4 py-6 lg:py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            <h2 className="font-serif font-bold text-foreground text-xl mb-4">
              Qu'est-ce que Étuve ?
            </h2>
            <div className="bg-primary/5 rounded-2xl border-2 border-primary/20 p-6">
              <p className="text-base text-foreground leading-relaxed">
                Étuve est un programme d'éducation thérapeutique numérique pour
                les patients en cure thermale. Il vous accompagne avant, pendant
                et après votre cure avec des outils concrets : fiches
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  <pillar.icon className="text-primary w-6 h-6 mb-3" />
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              <p className="text-base text-foreground leading-relaxed">
                Chaque conseil, chaque exercice, chaque recommandation de Étuve
                est basé sur des études de haute qualité méthodologique. Nos
                sources incluent :
              </p>
            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  ...
                  className="flex items-center justify-between bg-card rounded-xl border border-border hover:border-primary transition-all p-4"
                >
          ...
          <section className="text-center">
            <div className="bg-primary/5 rounded-2xl border-2 border-primary/20 p-8">
              <p className="font-serif font-bold text-foreground text-xl mb-3">
                Prêt à commencer ?
              </p>
