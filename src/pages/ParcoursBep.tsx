...
import { EmailOptinBep } from "@/components/parcours/EmailOptinBep";
...
const ParcoursBep = () => {
  ...
  const [koosItems, setKoosItems] = useState<(number | null)[]>(
    Array(7).fill(null),
  );
  ...
  const steps = useKoosPs
    ? allSteps
    : allSteps.filter((s) => !s.startsWith("pro-koos"));
    ...
    try {
      ...
      if (parcoursId) {
        const pro: ProAssessment = {
          ...
          koosPsTotal: useKoosPs
            ? calculateKoosPsScore(koosItems as number[])
            : 0,
      ...
      toast({
        title: "Erreur",
        description: "Impossible de sauvegarder. Veuillez réessayer.",
        variant: "destructive",
      });
    } finally {
      setSaving(false);
    ...
    switch (step) {
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Cette information aide à personnaliser votre programme.
              </p>
            </div>
            <BigChoice
              options={[
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Avez-vous déjà fait une cure thermale pour ce problème ?
              </p>
            </div>
            <BigChoice
              options={[
          ...
          <div className="space-y-6">
            ...
            <BigChoice
              options={[
                {
                  value: "moins-douleur",
                  label: "Moins de douleur",
                  desc: "Réduire mes douleurs au quotidien",
                },
                {
                  value: "mieux-bouger",
                  label: "Mieux bouger",
                  desc: "Retrouver de la mobilité et de la souplesse",
                },
                {
                  value: "reprendre-activite",
                  label: "Reprendre une activité",
                  desc: "Marche, sport, jardinage...",
                },
                {
                  value: "comprendre",
                  label: "Mieux comprendre ma maladie",
                  desc: "Savoir ce qui aide vraiment",
                },
                {
                  value: "mieux-dormir",
                  label: "Mieux dormir",
                  desc: "Réduire les douleurs nocturnes",
                },
              ]}
              value={mainGoal}
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Continuez à évaluer vos difficultés.
              </p>
            </div>
        ...
        return (
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                À quel point vous sentez-vous capable de gérer votre problème au
                quotidien ?
              </p>
            </div>
            <NrsScale
        ...
        return (
          <div className="space-y-8 text-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Voici vos scores initiaux. Vous les comparerez en fin de cure.
              </p>
            </div>

            {/* Scores */}
            <div
              className={`grid ${useKoosPs ? "grid-cols-3" : "grid-cols-2"} gap-4`}
            >
            ...
            <div className="p-6 rounded-xl bg-primary/5 border-2 border-primary/20">
              ...
              <p className="text-3xl font-mono font-bold text-primary mb-3">
                {token}
              </p>
              <p className="text-base text-muted-foreground mb-4">
                Notez ce code ! Il vous permettra de retrouver votre parcours et
                vos résultats.
              </p>
              <Button
                variant="outline"
      ...
      case "email":
        return (
          <EmailOptinBep
            token={token}
            onContinue={() => navigate(`/parcours/${slug}/jour/1`)}
          />
        );
          ...
          <div className="flex gap-3 mt-10">
            {currentIndex > 0 && (
              <Button
                ...
                size="lg"
                onClick={handleBack}
                className="text-lg py-6 px-6 gap-2"
              >
