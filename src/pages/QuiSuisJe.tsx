...
const principles = [
  ...
  { title: "Des niveaux 0 à 3", description: "Niveau 0 pour mobilité très limitée, niveau 3 pour les plus actifs. Vous choisissez ce qui vous correspond aujourd'hui." },
  { title: 'Une version "très facile"', description: "Pour l'obésité, la douleur chronique, la fatigue. Je pars de là où vous êtes, pas de là où vous « devriez » être." },
  { title: "Zéro culpabilisation", description: "Vous n'avez pas réussi hier ? On recommence aujourd'hui. C'est aussi simple que ça." },
  { title: "Tout est imprimable", description: "Chaque plan tient sur une page A4. Vous l'imprimez, vous l'affichez, vous cochez. C'est concret." },
];
